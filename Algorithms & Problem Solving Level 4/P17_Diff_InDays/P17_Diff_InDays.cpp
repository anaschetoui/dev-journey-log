...
int TotalDiff(stDate date1, stDate date2)
{
	int TotalDays = 0;
    
    while (IsDate1LessThanDate2(date1, date2))
	{
		// Increment date1 day by day until it matches date2, counting the days in between
		TotalDays++;
...
int main()
{
	...
	std::cout << "\nDiffrence is: " << TotalDiff(date1,date2) << " Day(s).\n";
	std::cout << "\nDifference (Including End Day) is: " << TotalDiff(date1, date2) + 1 << " Days(s)\n";
