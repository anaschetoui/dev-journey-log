/*
P42 - Decrease Date By One Decade

Write a program to read a date,
then decrease it by one decade (10 years).
...
The program should display the new date after subtracting one decade.
...
Date After:
Subtracting one decade is: 28/2/2014
*/
...
int main()
{
	...
	cout << "Subtracting One Decade is: " << GetDate(DecreaseDateByOneDecade(Date)) << endl;
	return 0;
}