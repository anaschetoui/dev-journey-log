...
then increase it by one millennium (1000 years).
...
The program should display the new date after adding one millennium.
...
Date After:
Adding one millennium is: 29/2/3020
*/
...
int main()
{
	...
	cout << "Adding One Millennium is: " << GetDate(IncreaseDateByOneMillennium(Date)) << endl;
