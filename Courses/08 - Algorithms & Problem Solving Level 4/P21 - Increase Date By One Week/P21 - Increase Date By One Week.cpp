...
then increase it by one week (7 days).
...
The program should display the new date after adding one week.
...
int main()
{
	...
	cout << "Date after adding One Week is: " << GetDate(IncreaseDateByOneWeek(Date)) << endl;
