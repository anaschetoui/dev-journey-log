...
then increase it by one century (100 years).
...
The program should display the new date after adding one century.
...
Date After:
Adding one century is: 28/2/2120
*/
...
int main()
{
	...
	cout << "Adding one century is: " << GetDate(IncreaseDateByOneCentury(Date)) << endl;
