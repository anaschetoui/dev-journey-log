/*
P39 - Decrease Date By One Year

Write a program to read a date,
then decrease it by one year.
...
The program should display the new date after subtracting one year.
...
Date After:
Subtracting one year is: 28/2/2023
*/
...
int main()
{
	...
	cout << "Subtracting one Year is: " << GetDate(DecreaseDateByOneYear(Date)) << endl;
	return 0;
}