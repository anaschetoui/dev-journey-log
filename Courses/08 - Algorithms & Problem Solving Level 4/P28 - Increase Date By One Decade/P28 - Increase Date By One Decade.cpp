...
then increase it by one decade (10 years).
...
The program should display the new date after adding one decade.
...
Date After:
Adding one decade is: 28/2/2030
*/
...
int main()
{
	...
	cout << "Adding One Decade is: " << GetDate(IncreaseDateByOneDecade(Date));
