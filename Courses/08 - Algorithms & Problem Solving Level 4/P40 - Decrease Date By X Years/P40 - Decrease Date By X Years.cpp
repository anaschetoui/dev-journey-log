/*
P40 - Decrease Date By X Years

Write a program to read a date
and a number of years to subtract from it.
...
The program should display the new date after subtracting the specified number of years.
...
How many years to subtract? 5

Date After:
Subtracting [5] years is: 28/2/2019
*/
...
{
	return DecreaseDateByXMonths(Date, 12 * HowManyYears);
}

int main()
{
	stDate Date = ReadDate();
	int HowManyYears = ReadNumber("How many years to subtract: ");


	cout << "Subtracting ["<<HowManyYears<<"] Years is: " << GetDate(DecreaseDateByXYears(Date,HowManyYears)) << endl;
	return 0;
}