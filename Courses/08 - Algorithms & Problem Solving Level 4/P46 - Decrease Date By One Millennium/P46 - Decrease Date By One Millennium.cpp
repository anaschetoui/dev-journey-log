...
then decrease it by one millennium (1000 years).
...
The program should display the new date after subtracting one millennium.
...
Date After:
Subtracting one millennium is: 29/2/1024
*/
...
int main()
{
	...
	cout << "Subtracting One Millennium is: " << GetDate(DecreaseDateByOneMillennium(Date)) << endl;
	return 0;
}